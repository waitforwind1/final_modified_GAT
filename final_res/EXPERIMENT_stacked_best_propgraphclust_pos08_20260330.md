...
That script writes attempt files under `final_res/results/` and a merged output file:

- `final_res/results/stacked_best_propgraphclust_pos08_selected_20run.txt`
...
- `fb_348`: `final_res/results/best_propgraphclust_pos08_individual_fb348_20run_seed0.txt`
- `fb_414`: `final_res/results/fb414_propgraphclust_pos08_thr0510_20run_try3_20260330.txt`
- `fb_686`: `final_res/results/hybrid_gate_repro_propgraphclust_pos08_20run_reproduced_20260330.txt`
- `fb_698`: `final_res/results/best_propgraphclust_pos08_individual_fb698_20run_seed0.txt`
- `fb_1684`: `final_res/results/fb1684_propgraphclust_pos08_thr0510_20run_20260330.txt`
- `mag_cs`: `final_res/results/magcs_propgraphclust_pos08_thr0510_20run_try8_20260330.txt`
